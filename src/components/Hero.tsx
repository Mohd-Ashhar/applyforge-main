...
const TRUST_ICONS = [
  { icon: Bot, label: "Autonomous Agents", color: "text-blue-400" },
  { icon: Cpu, label: "Self-Learning AI", color: "text-purple-400" },
  { icon: Clock, label: "24/7 Operation", color: "text-green-400" },
];
    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-950 via-background to-purple-900/80 overflow-hidden">
      ...
      >
        ...
        >
          ...
          to optimize your applications, bypass ATS barriers, and discover
        ...
        >
          {TRUST_ICONS.map(({ icon: Icon, label, color }) => (
            <div
              key={label}
              className="flex items-center gap-2 px-4 py-2 bg-background/20 rounded-lg border border-white/10"
            >
